                                ...
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.html" class="text-success">
                                            <span><img src="<?= $root ?>assets/images/logo.png" alt="" height="36"></span>
                                        </a>
                                    </h2>
...
<!--                                                 <div class="checkbox checkbox-success">
                                        ...
                                        <div class="form-group account-btn text-center m-t-10">
                                            <div class="col-xs-12">
                                                <button class="btn w-md btn-bordered btn-danger waves-effect waves-light" name="command" value="login" type="submit">Log In</button>
                                            </div>
                                        </div>
