...
class DataWrite
{
	...
	function register($user_id , $password , $name , $userType)
	{
		$connect = dbconnect() ;
		$query = mysqli_query($connect , "INSERT INTO users (user_id , password , username , access) VALUES('$user_id' , '$password' , '$name' , '$userType') ") ;
